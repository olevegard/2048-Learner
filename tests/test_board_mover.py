...
def test_that_join_adjecent_numbers_doesnt_change_grid():
    assert board_mover.join_adjacent_numbers([4, 0, 0, 0]) == [4, 0, 0, 0]
    assert board_mover.join_adjacent_numbers([2, 0, 4, 0]) == [2, 0, 4, 0]

def test_that_join_adjecent_numbers_joins_numbers():
    assert board_mover.join_adjacent_numbers([2, 2, 0, 0]) == [4, 0, 0, 0]
    assert board_mover.join_adjacent_numbers([0, 0, 4, 4]) == [0, 0, 8, 0]

def test_that_join_adjecent_numbers_joins_numbers_with_spaces_between():
    assert board_mover.join_adjacent_numbers([2, 0, 0, 2]) == [4, 0, 0, 0]
    assert board_mover.join_adjacent_numbers([4, 0, 0, 4]) == [8, 0, 0, 0]

def test_that_join_adjecent_numbers_joins_numbers_at_correct_index():
    assert board_mover.join_adjacent_numbers([0, 4, 4, 0]) == [0, 8, 0, 0]
    assert board_mover.join_adjacent_numbers([0, 0, 8, 8]) == [0, 0, 16, 0]

def test_that_join_adjecent_numbers_joins_numbers_at_correct_index_with_multiple_possible_joins():
    assert board_mover.join_adjacent_numbers([2, 2, 2, 0]) == [4, 0, 2, 0]
    assert board_mover.join_adjacent_numbers([0, 4, 4, 4]) == [0, 8, 0, 4]
    assert board_mover.join_adjacent_numbers([8, 0, 8, 8]) == [16, 0, 0, 8]

def test_that_join_multiple_groups():
    assert board_mover.join_adjacent_numbers([2, 2, 4, 4]) == [4, 0, 8, 0]
    assert board_mover.join_adjacent_numbers([4, 4, 2, 2]) == [8, 0, 4, 0]

def test_that_join_multiple_groups_of_same_number():
    assert board_mover.join_adjacent_numbers([2, 2, 2, 2]) == [4, 0, 4, 0]
    assert board_mover.join_adjacent_numbers([4, 4, 4, 4]) == [8, 0, 8, 0]

def test_that_we_cant_join_numbers_with_different_number_between():
    assert board_mover.join_adjacent_numbers([2, 4, 2, 0]) == [2, 4, 2, 0]
    assert board_mover.join_adjacent_numbers([4, 8, 4, 4]) == [4, 8, 8, 0]
...
def test_that_we_move_all_left():
    board = [
        0, 4, 2, 2,
        0, 4, 0, 0,
        0, 8, 2, 0,
    ...
    assert board_mover.move_all_left(board) == board_2
    ...
    assert board_mover.move_all_left(board_2) == board_3

def test_that_we_move_all_right():
    board = [
        0, 4, 2, 2,
        0, 4, 0, 0,
        0, 8, 2, 0,
    ...
    assert board_mover.move_all_right(board) == board_2
    ...
    assert board_mover.move_all_right(board_2) == board_3
